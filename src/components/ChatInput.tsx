                ...
                <div className="max-w-3xl mx-auto flex items-center gap-2">
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 relative">
                        <textarea
                            ...
                            disabled={isDisabled}
                            className="w-full p-3 pr-12 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed font-inter transition-all duration-200 bg-white border-gray-200 text-gray-900"
                            style={{
